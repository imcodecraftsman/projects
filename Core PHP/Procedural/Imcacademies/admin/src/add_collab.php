            ...
            <div class="py-4">
                ...
                <div class="d-flex justify-content-between w-100 flex-wrap">
                    <div class="mb-3 mb-lg-0">
                        <h1 class="h4">Add Collaborations</h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">     
                            <div class="row mb-4">
                                <div class="col-lg-12 col-sm-12">
                                    <!-- Form -->
                                    <form action="../functions/collab.php" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="exampleInputIconLeft">Company Name</label>
