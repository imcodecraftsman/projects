<?php 
  ...
  $id = $_GET['cid'];
  $data = mysqli_query($db->conn, "select * from `comittiee` where id='$id'");
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    ...
                                    <form action="../functions/comittiee.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="my-4">
                                            ...
                                            <textarea class="form-control" placeholder="Enter your message..." id="textarea" rows="4" required name="bio"><?=$res['bio']?></textarea>
                                        </div>
