                        ...
                        <div class="card-body">     
                            <div class="row mb-4">
                                <div class="col-lg-12 col-sm-12">
                                    <!-- Form -->
                                    <form action="../functions/comittiee.php" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                        ...
                                        <!-- <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputIconLeft" placeholder="Type" name="type">
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="my-4">
                                            ...
                                            <textarea class="form-control" placeholder="Biography ..." id="textarea" rows="4" required name="bio"></textarea>
                                        </div>
