            ...
            <div class="py-4">
                ...
                <div class="d-flex justify-content-between w-100 flex-wrap">
                    <div class="mb-3 mb-lg-0">
                        <h1 class="h4">Add Conferences</h1>
                    </div>
                </div>
            </div>
                                    ...
                                    <form action="../functions/conference.php" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputIconLeft" placeholder="Title" required name="title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputIconLeft" placeholder="Speaker" name="speaker">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputIconLeft" placeholder="Link" name="link">
                                            </div>
                                        </div>
