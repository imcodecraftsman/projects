          ...
          <div class="contact-form">
            ...
            <form action="contact_email.php" method="post">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <input type="number" name="phone" class="form-control mb-30" placeholder="Your Phone" required>
                </div>
                ...
                <div class="col-12">
                  <textarea name="msg" class="form-control mb-30" placeholder="Your Message" required></textarea>
                </div>
