                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <h1>Semi - Finish Boring Bars - ISO Cartridge Type</h1>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: pointer;">Semi - Finish Boring Bars - ISO Cartridge Type</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                    ...
                                    <ul id="none" class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item"><a class="first_sub_menu active">Semi - Finish Boring Bars</a><i class="first fa fa-angle-down" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup" style="display: block;">
                                                <li class="active_menu" ><a href="semi_finish_boring_bars_iso_cartridge_type.php?product_category=products"  style="color: white !important;">Semi-Finish Boring Bars - ISO Cartridge Type</a></li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                ...
                                <h5 class="entry-title">Semi-Finish Boring Bars - ISO Cartridge Type</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Semi-Finish Boring Bars - ISO Cartridge Type</h6>
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Semi - Finish Boring Bars - ISO Cartridge Type/Small 1.jpg" alt="include/img/Semi - Finish Boring Bars - ISO Cartridge Type/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                ...
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Advantage of using these type of tools is that ISO cartridges are globally standard.</li>
                                                ...
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Boring bars with ISO cartridges can also be designed & manufactured for combination boring application.</li>
