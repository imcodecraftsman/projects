                            ...
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: pointer;">Special Cartridges</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                    ...
                                    <ul class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item"><a class="first_sub_menu active">Cartridges</a><i class="first fa fa-angle-up" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup" style="display: block;" >
                                                ...
                                                <li class="active_menu"><a href="cartridges_special_cartridges.php?product_category=products" style="color: white !important;" >Special Cartridges</a></li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                <h5 class="entry-title">Special Cartridges</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Special Cartridges</h6>
                                   <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Special Cartridges/Small 1.jpg" alt="include/img/Special Cartridges/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                <li> <i class="fa fa-dot-circle-o"></i> &nbsp; Tailor made / Customized / Special cartridges designed & manufactured for all applications based on customer requirements.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
