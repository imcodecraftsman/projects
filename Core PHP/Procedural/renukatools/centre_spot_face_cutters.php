                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <h1>Centre Spot Face Cutters</h1>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: default;">Centre Spot Face Cutters</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <?php  if ($ProductCategory == 'products') {  ?>
                                ...
                                <div class="sidebar-single">
                                    ...
                                    <ul class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item active_menu"><a href="centre_spot_face_cutters.php?product_category=products" style="color: white !important;">Centre Spot Face Cutters</a></li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                <h5 class="entry-title">Centre Spot Face Cutters</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Centre Spot Face Cutters</h6>
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Centre Spot Face Cutters/Small 1.jpg" alt="include/img/Centre Spot Face Cutters/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                <li> <i class="fa fa-dot-circle-o"></i> &nbsp; Tailor made / Customized / Special Tools manufactured for Centre Cutting & Spot Facing application based on customer requirements.</li>
