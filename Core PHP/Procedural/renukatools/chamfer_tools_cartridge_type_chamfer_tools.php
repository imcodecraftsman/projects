                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <h1>Cartridge type Chamfer Tools</h1>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: default;">Cartridge type Chamfer Tools</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                    ...
                                    <ul class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item"><a class="first_sub_menu active">Chamfer Tools</a><i class="first fa fa-angle-up" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup" style="display: block;">
                                                ...
                                                <li class="active_menu" ><a href="chamfer_tools_cartridge_type_chamfer_tools.php?product_category=products"  style="color: white !important;">Cartridge type Chamfer Tools</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                <h5 class="entry-title">Cartridge type Chamfer Tools</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Cartridge type Chamfer Tools</h6>
                                   <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Cartridge Type Chamfer Tools/Small 1.jpg" alt="include/img/Cartridge Type Chamfer Tools/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                <li> <i class="fa fa-dot-circle-o"></i> &nbsp; Tailor made / Customized / Special Tools manufactured for Chamfering application based on customer requirements.</li>
                                                ...
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp;Cartridge can be ISO or non-standard depending on the customer requirements.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
