                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <h1>Adjustable diameter Chamfer Tools - Duo Chamfering Tools</h1>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php" style="color: #2a80b9;" >Home</a></li>
                                            <?php  if ($ProductCategory == 'products') {  ?>
                                                ...
                                                <li class="breadcrumb-item"><a href="chamfer_tools_product_page.php" style="color: #2a80b9;" >Chamfer Tools</a></li>
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: default;">Adjustable diameter Chamfer Tools - Duo Chamfering Tools</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <?php  if ($ProductCategory == 'products') {  ?>
                               ...
                               <div class="sidebar-single">
                                    ...
                                    <ul class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item"><a class="first_sub_menu active">Chamfer Tools</a><i class="first fa fa-angle-up" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup" style="display: block;">
                                                ...
                                                <li class="active_menu" ><a href="chamfer_tools_adjustable_diameter_chamfer_tools_duo_chamfering_tools.php?product_category=products"  style="color: white !important;">Adjustable diameter Chamfer Tools - Duo Chamfering Tools</a></li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                <h5 class="entry-title">Adjustable diameter Chamfer Tools - Duo Chamfering Tools</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Adjustable diameter Chamfer Tools - Duo Chamfering Tools</h6>
                                   <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Adjustable Diameter Chamfer Tools - Duo Chamfering Tools/Small 1.jpg" alt="include/img/Adjustable Diameter Chamfer Tools - Duo Chamfering Tools/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                <li> <i class="fa fa-dot-circle-o"></i> &nbsp; Adjustable diameter tools using the concept of Duo-Boring Bars can be manufactured and supplied as per customer requirements.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Minimum Diameter 10mm.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Available in all standard angles of 30°, 45° & 60°.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Can be manufactured for any other non-standard angle as well.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Available with option of Side Lock Type & Integral Taper Type (BT / BBT / HSK / SK / ISO / MT).</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
