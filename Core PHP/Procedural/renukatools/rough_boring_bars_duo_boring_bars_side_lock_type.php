                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <h1>Duo Boring Bars - Side Lock Type</h1>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: default;">Duo Boring Bars - Side Lock Type</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                            ...
                                            <ul class="slideup" style="display: block;">
                                                ...
                                                <li><a class="second_sub_menu active">Duo Boring Bars </a><i class="second fa fa-angle-down" style="float: right;margin-top: 5px;"></i>
                                                    <ul class="secondLevel" style="display: block;">
                                                        ...
                                                        <li class="active_menu"><a href="rough_boring_bars_duo_boring_bars_side_lock_type.php?product_category=products" style="color: white !important;">Duo Boring Bars - Side Lock Type</a></li>
                                           ...
                                           <!--  <li class="list-group-item"><a href="cartridges_finish_boring_cartridges.php?product_category=std_products">Finish Boring Cartridges</a></li> -->
                                            ...
                                            <li class="list-group-item"><a class="first_sub_menu active">Duo Boring Bars</a><i class="first fa fa-angle-down" style="float: right;margin-top: 5px;"></i>
                                                <ul class="slideup" style="display: block;">
                                                    ...
                                                    <li class="active_menu"><a href="rough_boring_bars_duo_boring_bars_side_lock_type.php?product_category=std_products" style="color: white !important;">Duo Boring Bars - Side Lock Type</a></li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                <h5 class="entry-title">Duo Boring Bars - Side Lock Type</h5>
                                <div class="product-review-info">
                                    <ul class="nav review-tab">
                                        <li> <a class="active" data-toggle="tab" href="#rough_boring_bars_duo_boring_bars_side_lock_type_tab_one">For TC.. Inserts</a> </li>
                                        <li> <a data-toggle="tab" href="#rough_boring_bars_duo_boring_bars_side_lock_type_tab_two">For CC.. Inserts</a> </li>
                                    </ul>
                                    <div class="tab-content reviews-tab">
                                        <div class="tab-pane fade show active" id="rough_boring_bars_duo_boring_bars_side_lock_type_tab_one">
                                            <h6 class="tab_heading">Side lock Type Duo Boring Bar For TC..Inserts</h6>
                                            <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For TC Inserts/Small 1.jpg" alt="include/img/DUO_SideLock/For TC Inserts/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For TC Inserts/Small 2.jpg" alt="include/img/DUO_SideLock/For TC Inserts/Big 2.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-1"> </div>
                                            </div>
                                            <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For TC Inserts/Small 3.jpg" alt="include/img/DUO_SideLock/For TC Inserts/Big 3.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For TC Inserts/Small 4.jpg" alt="include/img/DUO_SideLock/For TC Inserts/Big 4.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-1"> </div>
                                            </div>
                                            ...
                                            <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                                <div class="col-md-12">
                                                    <ul>
                                                        <li> <i class="fa fa-dot-circle-o"></i> &nbsp; For all the above boring bars, any standard Side-Lock adaptor can be used with diameter equal to “Ød” mentioned above.</li>
                                        ...
                                        <div class="tab-pane fade" id="rough_boring_bars_duo_boring_bars_side_lock_type_tab_two">
                                            <h6 class="tab_heading">Side lock Type Duo Boring Bar For CC..Inserts</h6>
                                            <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For CC Inserts/Small 1.jpg" alt="include/img/DUO_SideLock/For CC Inserts/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For CC Inserts/Small 2.jpg" alt="include/img/DUO_SideLock/For CC Inserts/Big 2.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-1"> </div>
                                            </div>
                                            <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For CC Inserts/Small 3.jpg" alt="include/img/DUO_SideLock/For CC Inserts/Big 3.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-5">
                                                    <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/DUO_SideLock/For CC Inserts/Small 4.jpg" alt="include/img/DUO_SideLock/For CC Inserts/Big 4.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                                </div>
                                                <div class="col-md-1"> </div>
                                            </div>
                                            <h6 class="tab_heading">Specification Chart</h6>
