                                    ...
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php" style="color: #2a80b9;" >Home</a></li>
                                            <?php  if ($ProductCategory == 'products') {  ?>
                                                ...
                                                <li class="breadcrumb-item"><a href="drilling_tools_product_page.php" style="color: #2a80b9;" >Drilling Tools</a></li>
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: default;">Trepanning Tools</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <?php  if ($ProductCategory == 'products') {  ?>
                               ...
                               <div class="sidebar-single">
                                    ...
                                    <ul class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item"><a href="spot_face_cutters.php?product_category=products">Trepanning Tools</a></li>
                                        <li class="list-group-item"><a href="centre_spot_face_cutters.php?product_category=products">Centre Trepanning Tools</a></li>
                                        <li class="list-group-item"><a class="first_sub_menu active">Drilling Tools</a><i class="first fa fa-angle-up" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup" style="display: block;" >
                                                <li><a href="drilling_tools_u_drills.php?product_category=products">U - Drills</a></li>
                                                <li class="active_menu" ><a href="drilling_tools_trepanning_drills.php?product_category=products" style="color: white !important;">Trepanning Tools</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                <h5 class="entry-title">Trepanning Tools</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Trepanning Tools</h6>
                                   <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Trepanning Tools/Small 1.jpg" alt="include/img/Trepanning Tools/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                <li> <i class="fa fa-dot-circle-o"></i> &nbsp; Tailor made / Customized / Special Tools manufactured for Large Hole Drilling application based on customer requirements.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Available with option of Side Lock Type & Integral Taper Type (BT / BBT / HSK / SK / ISO / MT).</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Available with Option of Cartridge Type & Fixed Pocket Type.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
