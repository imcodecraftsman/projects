                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <h1>Fixed Pocket type Rough Boring Bars (Core Drills)</h1>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a class="breadcrumb-disabled">Fixed Pocket type Rough Boring Bars (Core Drills)</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <?php  if ($ProductCategory == 'products') {  ?>
                                ...
                                <div class="sidebar-single">
                                    ...
                                    <ul id="none" class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item"><a class="first_sub_menu">Semi - Finish Boring Bars</a><i class="first fa fa-angle-down" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup">
                                        ...
                                        <li class="list-group-item"><a class="first_sub_menu active">Rough Boring Bars</a><i class="first fa fa-angle-up" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup" style="display: block;">
                                                <li  class="active_menu" ><a href="rough_boring_bars_fixed_pocket_type.php?product_category=products" style="color: white !important;">Fixed Pocket type Rough Boring Bars (Core Drills)</a></li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                ...
                                <h5 class="entry-title">Fixed Pocket type Rough Boring Bars (Core Drills)</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Fixed Pocket type Rough Boring Bars (Core Drills)</h6>
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Fixed Pocket Type Rough Boring Bars (Core Drills)/Small 1.jpg" alt="include/img/Fixed Pocket Type Rough Boring Bars (Core Drills)/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                <li> <i class="fa fa-dot-circle-o"></i> &nbsp;Tailor made / Customized / Special Tools manufactured for rough boring  application based on customer requirements.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Available with Through Spindle Coolant option for better Tool-Life.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Option available for straight flutes & helical flutes both.</li>
                                                ...
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Boring bars with fixed pockets  can also be designed & manufactured for combination boring application.</li>
