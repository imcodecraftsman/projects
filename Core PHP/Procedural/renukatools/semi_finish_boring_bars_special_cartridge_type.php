                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrap">
                                <nav aria-label="breadcrumb">
                                    <h1>Semi - Finish Boring Bars - Special Cartridge Type</h1>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php" style="color: #2a80b9;" >Home</a></li>
                                            <?php  if ($ProductCategory == 'products') {  ?>
                                                ...
                                                <li class="breadcrumb-item"><a href="semi_finish_boring_bars_product_page.php" style="color: #2a80b9;" >Semi - Finish Boring Bars</a></li>
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a style="cursor: pointer;">Semi - Finish Boring Bars - Special Cartridge Type</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 order-1 order-lg-1">
                            ...
                            <?php  if ($ProductCategory == 'products') {  ?>
                                ...
                                <div class="sidebar-single">
                                    ...
                                    <ul id="none" class="list-group" style="margin: 10px 0px 5px 0px;">
                                        ...
                                        <li class="list-group-item"><a class="first_sub_menu active">Semi - Finish Boring Bars</a><i class="first fa fa-angle-down" style="float: right;margin-top: 5px;"></i>
                                            <ul class="slideup" style="display: block;">
                                                ...
                                                <li  class="active_menu" ><a href="semi_finish_boring_bars_special_cartridge_type.php?product_category=products" style="color: white !important;">Semi-Finish Boring Bars - Special Cartridge Type</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-lg-9 order-2 order-lg-2">
                            <div style="padding: 25px 15px;">
                                ...
                                <h5 class="entry-title">Semi-Finish Boring Bars - Special Cartridge Type</h5>
                                <div class="product-review-info" style="border: 0.5px solid #d2d2d2b8;padding: 15px 20px 20px;" >
                                    <h6 class="tab_heading">Semi-Finish Boring Bars - Special Cartridge Type</h6>
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-1"> </div>
                                            <div class="col-md-10"> 
                                                <a href="javascript:void(0)" class="pop_up_image"> <img src="include/img/Semi - Finish Boring Bars - Special Cartridge Type/Small 1.jpg" alt="include/img/Semi - Finish Boring Bars - Special Cartridge Type/Big 1.jpg" style="cursor: zoom-in;" oncontextmenu="return false;"> </a>
                                            </div>
                                        <div class="col-md-1"> </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px 5px 5px 10px;margin-top: 10px;">
                                        <div class="col-md-12">
                                            <ul>
                                                <li> <i class="fa fa-dot-circle-o"></i> &nbsp; Tailor made / Customized / Special Tools manufactured for Close Tolerance Boring  application of less than 50 microns tolerance based on customer requirements.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Available with Through Spindle Coolant option for better Tool-Life.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; These are specifically designed and manufactured for applications with restricted lengths and diameters.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; For extra long cutting length (L/D>3.5), antivibration boring bars can be manufactured & supplied.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Boring bars with special cartridges can also be designed & manufactured for combination boring application.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Cartridges used in boring bars helps in achieving some fine adjustments in dimensions.</li>
                                                <li><i class="fa fa-dot-circle-o"></i> &nbsp; Available with option of Side Lock Type, Cylindrical Shank Type, Arbor Type, Integral Taper Type (BT / BBT / HSK / SK / ISO / MT).</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
