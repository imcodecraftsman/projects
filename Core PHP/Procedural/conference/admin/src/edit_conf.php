<?php 
  ...
  $id = $_GET['cid'];
  $data = mysqli_query($db->conn, "select * from `conference` where id='$id'");
            ...
            <div class="py-4">
                ...
                <div class="d-flex justify-content-between w-100 flex-wrap">
                    <div class="mb-3 mb-lg-0">
                        <h1 class="h4">Edit Conferences</h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">     
                            <div class="row mb-4">
                                <div class="col-lg-12 col-sm-12">
                                    <!-- Form -->
                                    <form action="../functions/conference.php" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="exampleInputIconLeft">Title</label>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputIconLeft" placeholder="Title" required name="title" value="<?=$res['title']?>">
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label for="exampleInputIconLeft">Speaker</label>
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon1">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputIconLeft" placeholder="Speaker" name="speaker" value="<?=$res['speaker']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="my-4">
                                            ...
                                            <textarea class="form-control" placeholder="Enter your message..." id="textarea" rows="4" required name="desc"><?=$res['desc']?></textarea>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input data-datepicker="" class="form-control datepicker-input" id="birthday" type="text" placeholder="mm/dd/yyyy" required name="datetime" value="<?=date("m/d/Y", strtotime($res['date_time']))?>">                                               
                                        </div>
                                    </div>
