    ...
    <main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            ...
            <?php if(isset($_GET['msg']) && $_GET['msg'] == "fail"){ ?>    
                <p class="text-center">
                    <label class="alert alert-danger">Login Failed. Please try again.</label>
                </p>
            <?php } ?>
                <div class="row justify-content-center form-bg-image" >
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="functions/admin.php" class="mt-4" method="post">
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="Enter Email" name="email" id="email" autofocus required>
                                    </div>  
                                </div>
                                <!-- End of Form -->
