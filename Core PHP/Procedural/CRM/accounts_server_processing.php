...
$aColumns = array('LoginId','LoginId','LoginType','LManagerId','LEmployeeId','LoginId','FirstName','LastName','MobileNumber','UserName','Password','LoginType','LastUpdated');
    /* Indexed column (used for fast and accurate table cardinality) */
        $sIndexColumn = "LoginId";
  ...
  $sWhere = " WHERE LoginType != 'Client' AND LoginType != 'Admin'";
       ...
       /*     if ($_SESSION['login_user'] != 'admin') 
            {    
                ...
                $sWhere .= "updated_by = ".$_SESSION['user_id']." || doctor_id = ".$_SESSION['login_doctor_id'];
