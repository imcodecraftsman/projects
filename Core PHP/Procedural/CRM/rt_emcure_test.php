...
<div id="page-wrapper">
	<div class="header">
		<h1 class="page-header">Recovery Indoco Sheet</h1>
		<ol class="breadcrumb">
		  <li><a href="#">Dashboard</a></li>
      <li><a href="test_management.php">Test Management</a></li>
      <li><a href="recovery_test.php">Recovery Test</a></li>
		  <li class="active" ><a>Recovery Indoco Sheet</a></li>
		</ol> 
	</div>
			...
			<div class="col-lg-12">
              ...
              <br>
                  ...
                  <div class="row" style="text-align: right;">
                      <input type="button" class="btn btn-primary" id="rt_emcure_table_add_new_row" value="Add Row" />
                  </div>

                  <div class="table-responsive mt-15" >
                    
                      <table  id="rt_emcure_table" class="table table-striped table-bordered table-hover rt_emcure_table">
                          <thead> 
                            <tr>
                              <th rowspan="3">Room Name</th>
                              <th rowspan="3">AHU Condition</th>
                              <th rowspan="3">Time of Reading</th>
                              <th colspan="2">Particle Count Reading Mt3</th>
                          ...
                          <tbody>
                              <tr>
                                <td><input type="text"  id="rt_emcure_room_name" name="rt_emcure_room_name[]" class="form-control" /></td>
                                <td><input type="text"  id="rt_emcure_ahu_condition" name="rt_emcure_ahu_condition[]" class="form-control"/></td>
                                <td><input type="text"  id="rt_emcure_time_of_reading" name="rt_emcure_time_of_reading[]" class="form-control"/></td>
                                <td><input type="text"  id="rt_emcure_particle_count_reading_mt_05u" name="rt_emcure_particle_count_reading_mt_05u[]" class="form-control"/></td>
                                <td><input type="text"  id="rt_emcure_particle_count_reading_mt_50u" name="rt_emcure_particle_count_reading_mt_50u[]" class="form-control" /></td>
                                <td><input type="text"  id="rt_emcure_remarks" name="rt_emcure_remarks[]" class="form-control"/></td>
                                <td></td>
                              </tr>
                            <input type="hidden" id="deleted_rt_emcure_id" name="deleted_rt_emcure_id">
                        </tbody>
                     </table>
                  </div>
...
//alert(nursing_row_count);
    ...
    $("#rt_emcure_table_add_new_row").on("click", function () 
    { 
        var newRow = $("<tr>");
        var cols = "";
        

        cols += '<td><input type="text"  id="rt_emcure_room_name'+avs_count+'" name="rt_emcure_room_name[]" class="form-control" /></td>';

        cols += '<td><input type="text"  id="rt_emcure_ahu_condition'+avs_count+'" name="rt_emcure_ahu_condition[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="rt_emcure_time_of_reading'+avs_count+'" name="rt_emcure_time_of_reading[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="rt_emcure_particle_count_reading_mt_05u'+avs_count+'" name="rt_emcure_particle_count_reading_mt_05u[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="rt_emcure_particle_count_reading_mt_50u'+avs_count+'"  name="rt_emcure_particle_count_reading_mt_50u[]" class="form-control" /></td>';

        cols += '<td><input type="text"  id="rt_emcure_remarks'+avs_count+'"  name="rt_emcure_remarks[]" class="form-control"/></td>';
        
        cols += '<td><i class="rt_emcure_table_current_row fa fa-times-circle-o" style="color: red;font-size: 30px;padding: 2px 5px;cursor:pointer;" ></i></td>';
        newRow.append(cols);

        $("table.rt_emcure_table").append(newRow);
        avs_count++;

    });

    $("table.rt_emcure_table").on("click", ".rt_emcure_table_current_row", function (event) {
       ...
       // nursing_row_count -= 1
         ...
         var prvalthd = $("#deleted_rt_emcure_id").val();

         if (prvalthd) 
         {
           deleted_rt_emcure_id = prvalthd+','+deleted_row_id
         }else
         {
           deleted_rt_emcure_id = deleted_row_id;
         }

        $("#deleted_rt_emcure_id").val(deleted_row_id);
