...
<html>
<head>
<title>Shlok Electronics Payment</title>
<!-- for-mobile-apps -->
...
<body style="background: black;">
	<div class="row">
		<div class="col-md-12" style="background-color: grey;">
			<a href="../index.php"><button class="btn btn-danger" style="height: 40px; background-color: red; color: white;">HOME</button></a>
		</div>
	</div>
	<div class="main">
		<h1 style="color: #0070ff">Payment Mode</h1>
		<div class="content">
					...
					<script type="text/javascript">
						...
						<div class="sap_tabs">
							<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
								<div class="pay-tabs">
									<h2 style="color: black;">SELECT PAYMENT METHOD</h2>
								...
								<div class="resp-tabs-container">
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="payment-info">
											...
											<form>
												...
												<input type="submit" style="background-color: #0070ff;" value="SUBMIT">
											</form>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="payment-info">
											<h3 style="color: black;">NET BANKING</h3>
											...
											<a href="#"  style="background-color: #0070ff;">Continue</a>
										</div>
									</div>
														...
														<input type="password" value="PASSWORD" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'PASSWORD';}" required="">
															<div class="user-grids">
																...
																<div class="user-right">
																	<input type="submit"  style="background-color: #0070ff;" value="LOGIN">
																</div>
																<div class="clear"></div>
															</div>
													</form>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">	
										<div class="payment-info">
											...
											<h3 class="pay-title" style="color: black;">DEBIT CARD INFO</h3>
											<form>
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
														<input type="text" value="">
