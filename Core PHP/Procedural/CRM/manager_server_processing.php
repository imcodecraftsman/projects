<?php
    ...
    $aColumns = array('ManagerId','ManagerId','ManagerFirstName','ManagerLastName','ManagerDesignation','ManagerMobileNumber','ManagerEmailId','ManagerPassword','LastUpdated');
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "ManagerId";
