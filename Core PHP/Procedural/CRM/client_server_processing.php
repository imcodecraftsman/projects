<?php
    ...
    $aColumns = array('ClientId','ClientId','ClientCompanyName','ClientFirstName','ClientLastName','ClientMobileNumber','ClientEmailId','ClientFrequency','LastUpdated');
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "ClientId";
