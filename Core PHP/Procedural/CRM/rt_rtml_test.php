			...
			<div class="col-lg-12">
              ...
              <br>
                  ...
                  <div class="row" style="text-align: right;">
                      <input type="button" class="btn btn-primary" id="rt_rtml_table_add_new_row" value="Add Row" />
                  </div>

                  <div class="table-responsive mt-15" >
                    
                      <table  id="rt_rtml_table" class="table table-striped table-bordered table-hover rt_rtml_table">
                          <thead> 
                            <tr>
                              <th rowspan="3">Room Name</th>
                              <th rowspan="3">Description</th>
                              <th rowspan="3">Time of Reading</th>
                              <th colspan="2">Particle Count in (m3)</th>
                          ...
                          <tbody>
                              <tr>
                                <td><input type="text"  id="rt_rtml_room_name" name="rt_rtml_room_name[]" class="form-control" /></td>
                                <td><input type="text"  id="rt_rtml_description" name="rt_rtml_description[]" class="form-control"/></td>
                                <td><input type="text"  id="rt_rtml_time_of_reading" name="rt_rtml_time_of_reading[]" class="form-control"/></td>
                                <td><input type="text"  id="rt_rtml_particle_count_in_m3_05u" name="rt_rtml_particle_count_in_m3_05u[]" class="form-control"/></td>
                                <td><input type="text"  id="rt_rtml_particle_count_in_m3_50u" name="rt_rtml_particle_count_in_m3_50u[]" class="form-control" /></td>
                                <td><input type="text"  id="rt_rtml_remarks" name="rt_rtml_remarks[]" class="form-control"/></td>
                                <td></td>
                              </tr>
                            <input type="hidden" id="deleted_rt_rtml_id" name="deleted_rt_rtml_id">
                        </tbody>
                     </table>
                  </div>
...
//alert(nursing_row_count);
    ...
    $("#rt_rtml_table_add_new_row").on("click", function () 
    { 
        var newRow = $("<tr>");
        var cols = "";
        

        cols += '<td><input type="text"  id="rt_rtml_room_name'+avs_count+'" name="rt_rtml_room_name[]" class="form-control" /></td>';

        cols += '<td><input type="text"  id="rt_rtml_description'+avs_count+'" name="rt_rtml_description[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="rt_rtml_time_of_reading'+avs_count+'" name="rt_rtml_time_of_reading[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="rt_rtml_particle_count_in_m3_05u'+avs_count+'" name="rt_rtml_particle_count_in_m3_05u[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="rt_rtml_particle_count_in_m3_50u'+avs_count+'"  name="rt_rtml_particle_count_in_m3_50u[]" class="form-control" /></td>';

        cols += '<td><input type="text"  id="rt_rtml_remarks'+avs_count+'"  name="rt_rtml_remarks[]" class="form-control"/></td>';
        
        cols += '<td><i class="rt_rtml_table_current_row fa fa-times-circle-o" style="color: red;font-size: 30px;padding: 2px 5px;cursor:pointer;" ></i></td>';
        newRow.append(cols);

        $("table.rt_rtml_table").append(newRow);
        avs_count++;

    });

    $("table.rt_rtml_table").on("click", ".rt_rtml_table_current_row", function (event) {
       ...
       // nursing_row_count -= 1
         ...
         var prvalthd = $("#deleted_rt_rtml_id").val();

         if (prvalthd) 
         {
           deleted_rt_rtml_id = prvalthd+','+deleted_row_id
         }else
         {
           deleted_rt_rtml_id = deleted_row_id;
         }

        $("#deleted_rt_rtml_id").val(deleted_row_id);
