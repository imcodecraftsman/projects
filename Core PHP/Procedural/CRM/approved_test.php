...
<div id="page-wrapper">
	<div class="header">
		<h1 class="page-header">Approved Test</h1>
		<ol class="breadcrumb">
		  <li><a href="#">Dashboard</a></li>
		  <li class="active" ><a>Approved Test</a></li>
		</ol> 
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
              ...
              <div class="table-responsive">
              	<div style="margin-top: 10px;" id="TestApprovedDatatable" class="table-responsive"></div>
              </div>
...
$(document).ready(function() {
  ...
  TestApprovedDatatable();

});



function TestApprovedDatatable()
{ 

    $('#TestApprovedDatatable').empty().html( '<table  id="main_datatable" class="table table-bordered"  style="width: 100%;"  ></table>' );
    ...
    {       
            ...
            // "iDisplayLength":10,
            //"bJQueryUI": true,
            "sAjaxSource": "approved_test_server_processing.php",  
            "aaSorting": [],
            ...
            [
              ...
              { 
                ...
                { 
                        ...
                        if(astatus == "Yes" && status == "True")
                        {

                          return  "<td><b style='color:green;' >Test Approved</b></td>";
