<?php
    ...
    $aColumns = array('TestId','Status','ApproveStatus','TemplatePageName','ClientName','TestName','TemplateName','LastUpdated');
    ...
    if ($user_type == "Admin") {
        ...
        $sWhere = " WHERE Status = 'True' AND ApproveStatus = 'Yes'";

    }/*else if($EmployeeId != 0) {

        $sWhere = " WHERE EmployeeId = ".$EmployeeId;
