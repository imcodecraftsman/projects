...
<div id="page-wrapper">
	<div class="header">
		<h1 class="page-header">Particle Coun Format RTML Sheet</h1>
		<ol class="breadcrumb">
      ...
      <li><a href="particle_coun_format_test.php">Particle Coun Format Test</a></li>
		  <li class="active" ><a>Particle Coun Format RTML Sheet</a></li>
		</ol> 
	</div>
			...
			<div class="col-lg-12">
              ...
              <br>
                  ...
                  <div class="row" style="text-align: right;">
                      <input type="button" class="btn btn-primary" id="pcf_rtml_table_add_new_row" value="Add Row" />
                  </div>

                  <div class="table-responsive mt-15" >
                    
                      <table  id="pcf_rtml_table" class="table table-striped table-bordered table-hover pcf_rtml_table">
                          <thead> 
                            <tr>
                              <th rowspan="3" >Room Name</th>
                              <th rowspan="3" >Location No.</th>
                              <th colspan="2" >Particle Readings/m3</th>
                          ...
                          <tbody>
                              <tr>
                                <td><input type="text"  id="pcf_rtml_room_name" name="pcf_rtml_room_name[]" class="form-control" /></td>
                                <td><input type="text"  id="pcf_rtml_location_no" name="pcf_rtml_location_no[]" class="form-control"/></td>

                                <td><input type="text"  id="pcf_rtml_particle_readings_m3_05u" name="pcf_rtml_particle_readings_m3_05u[]" class="form-control"/></td>
                                <td><input type="text"  id="pcf_rtml_particle_readings_m3_50u" name="pcf_rtml_particle_readings_m3_50u[]" class="form-control" /></td>
                                <td><input type="text"  id="pcf_rtml_remarks" name="pcf_rtml_remarks[]" class="form-control"/></td>
                                <td></td>
                              </tr>
                            <input type="hidden" id="deleted_pcf_rtml_id" name="deleted_pcf_rtml_id">
                        </tbody>
                     </table>
                  </div>
...
//alert(nursing_row_count);
    ...
    $("#pcf_rtml_table_add_new_row").on("click", function () 
    { 
        var newRow = $("<tr>");
        var cols = "";
        

        cols += '<td><input type="text"  id="pcf_rtml_room_name'+avs_count+'" name="pcf_rtml_room_name[]" class="form-control" /></td>';

        cols += '<td><input type="text"  id="pcf_rtml_location_no'+avs_count+'" name="pcf_rtml_location_no[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="pcf_rtml_particle_readings_m3_05u'+avs_count+'" name="pcf_rtml_particle_readings_m3_05u[]" class="form-control"/></td>';

        cols += '<td><input type="text"  id="pcf_rtml_particle_readings_m3_50u'+avs_count+'"  name="pcf_rtml_particle_readings_m3_50u[]" class="form-control" /></td>';

        cols += '<td><input type="text"  id="pcf_rtml_remarks'+avs_count+'"  name="pcf_rtml_remarks[]" class="form-control"/></td>';
        
        cols += '<td><i class="pcf_rtml_table_current_row fa fa-times-circle-o" style="color: red;font-size: 30px;padding: 2px 5px;cursor:pointer;" ></i></td>';
        newRow.append(cols);

        $("table.pcf_rtml_table").append(newRow);
        avs_count++;

    });

    $("table.pcf_rtml_table").on("click", ".pcf_rtml_table_current_row", function (event) {
       ...
       // nursing_row_count -= 1
         ...
         var prvalthd = $("#deleted_pcf_rtml_id").val();

         if (prvalthd) 
         {
           deleted_pcf_rtml_id = prvalthd+','+deleted_row_id
         }else
         {
           deleted_pcf_rtml_id = deleted_row_id;
         }

        $("#deleted_pcf_rtml_id").val(deleted_row_id);
