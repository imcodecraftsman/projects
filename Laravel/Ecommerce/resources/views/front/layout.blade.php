<?php
    $getCountOfCartItems = getCountOfCartItems();
    $totalItemCount = count($getCountOfCartItems);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <div class="aa-cartbox">
                ...
                <?php if ($totalItemCount > 0) {
                    ...
                    <div class="aa-cartbox-summary">
                        <ul>
                          <?php  foreach ($getCountOfCartItems as $item) {
                            $totalItemPrice = $totalItemPrice +($item->product_quantity * $item->product_attribute_price);
                            ?>
                          <li>
                            <a class="aa-cartbox-img" href="#"><img src="{{asset('storage/media/'.$item->product_image)}}" alt="{{$item->product_image}}"></a>
                            <div class="aa-cartbox-info">
                              <h4><a href="#">{{$item->product_name}}</a></h4>
                              <p>{{$item->product_quantity}} x Rs. {{$item->product_attribute_price}}</p>
                            </div>
