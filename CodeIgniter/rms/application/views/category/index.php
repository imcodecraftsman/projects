        ...
        <div class="modal-body">
		  ...
		  <div class="form-group">
                  ...
                  <select class="form-control" id="maincategory" name="maincategory" >
                      ...
                      <option value="<?php echo 'inventory' ?>"><?php echo 'inventory' ?></option>
      ...
      <form role="form" action="<?php echo base_url('category/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
		   ...
		   <div class="form-group">
                  <label for="category">Category</label>
                  <select class="form-control" id="editmaincategory" name="editmaincategory">
...
{ 
  $.ajax({
    ...
    success:function(response) {
	  ...
	  $("#editmaincategory").val(response.active);
