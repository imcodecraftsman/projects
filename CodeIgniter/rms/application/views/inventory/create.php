          ...
          <form role="form"  id="forms" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
					...
					<input type="radio" class="radioBtnClass" name="current_period_assign" value="parcel" onclick="show_service()" checked /><label class="lblcls"  style="margin-left: 7px; margin-right: 7px;">All</label>
                ...
                <table class="table table-bordered table-hover" id="product_info_table">
                  <thead>
                    <tr>
                      ...
                      <th style="width:30%">Rate ( Kg/Pkt/Lir )</th>
			  ...
			  <div class="pull pull-right">
			   <span id="error_msg2"  style="display:none"></span>
                ...
                <button type="button" onclick="save()" class="btn btn-success">Create</button>
...
function show_service2(){
 ...
 function totalrr(){
	  ...
	  var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+product+'<input type="hidden" name="product[]" id="product_'+row_id+'" class="form-control products" onkeyup="" value="'+product_val+'"></td><td><input type="number" name="qty[]" id="qty_'+row_id+'" class="form-control" onchange="getTotal('+row_id+')" value=""></td>'+
                    '<td><input type="number" name="rate[]" id="rate_'+row_id+'" value="" class="form-control" onchange="getTotal('+row_id+')"></td>'+
					'<td><input type="text" name="rateper" id="rateper_value'+row_id+'" class="form-control" disabled><input type="hidden" name="rateper_value[]" id="rateper_value'+row_id+'" class="form-control"></td>'+
                    '<td><button type="button" class="btn btn-default" onclick="removeRow(\''+row_id+'\')"><i class="fa fa-close"></i></button></td>'+
                    '</tr>';
      ...
      if($("#qty_"+row).val()!='' && $("#rate_"+row).val()!=''){
	   ...
	   //alert($("#rate_"+row).val());
		    ...
		    var total = (Number($("#rate_"+row).val())/Number($("#qty_"+row).val()));
             total = total.toFixed(2);
			 alert(total);
			 $('#rateper_'+row).val(total);
			 $('#rateper_value'+row).val(total);
  ...
  function subAmount() {
   ...
   // var vat_charge = <?php echo ($company_data['vat_charge_value'] > 0) ? $company_data['vat_charge_value']:0; ?>;
    ...
    for(x = 0; x < tableProductLength; x++) {
      ...
      totalSubAmount = Number(totalSubAmount) + Number($("#rate_"+count).val());
    } // /for
